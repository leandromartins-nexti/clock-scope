...
export const sparklineData = {
  qualidadePonto: {
    ...
    corLinha: "#22c55e",
    evolucao: [
      { competencia: "abr/25", valor: 83.2 }, { competencia: "mai/25", valor: 83.5 },
      { competencia: "jun/25", valor: 84.0 }, { competencia: "jul/25", valor: 84.3 },
      { competencia: "ago/25", valor: 84.8 }, { competencia: "set/25", valor: 85.1 },
      { competencia: "out/25", valor: 85.6 }, { competencia: "nov/25", valor: 86.0 },
      { competencia: "dez/25", valor: 86.2 }, { competencia: "jan/26", valor: 86.7 },
      { competencia: "fev/26", valor: 87.0 }, { competencia: "mar/26", valor: 87.3 },
    ],
  },
  absenteismo: {
    label: "Absenteísmo",
    ...
    corLinha: "#22c55e",
    evolucao: [
      { competencia: "abr/25", valor: 5.4 }, { competencia: "mai/25", valor: 5.6 },
      { competencia: "jun/25", valor: 5.2 }, { competencia: "jul/25", valor: 5.8 },
      { competencia: "ago/25", valor: 5.3 }, { competencia: "set/25", valor: 5.0 },
      { competencia: "out/25", valor: 5.4 }, { competencia: "nov/25", valor: 4.9 },
      { competencia: "dez/25", valor: 5.1 }, { competencia: "jan/26", valor: 4.7 },
      { competencia: "fev/26", valor: 4.9 }, { competencia: "mar/26", valor: 4.8 },
    ],
  },
  volumeHE: {
    label: "Volume HE",
    ...
    evolucao: [
      ...
      { competencia: "dez/25", valor: 44.8 }, { competencia: "jan/26", valor: 34.2 },
  ...
  movimentacoes: {
    ...
    corLinha: "#22c55e",
    evolucao: [
      { competencia: "abr/25", valor: 28.1 }, { competencia: "mai/25", valor: 27.5 },
      { competencia: "jun/25", valor: 27.0 }, { competencia: "jul/25", valor: 26.3 },
      { competencia: "ago/25", valor: 25.8 }, { competencia: "set/25", valor: 25.2 },
      { competencia: "out/25", valor: 24.8 }, { competencia: "nov/25", valor: 24.3 },
      { competencia: "dez/25", valor: 24.0 }, { competencia: "jan/26", valor: 23.6 },
      { competencia: "fev/26", valor: 23.3 }, { competencia: "mar/26", valor: 23.0 },
    ],
  },
  coberturaEfetiva: {
    ...
    corLinha: "#f97316",
    evolucao: [
      { competencia: "abr/25", valor: 70 }, { competencia: "mai/25", valor: 70 },
      { competencia: "jun/25", valor: 70 }, { competencia: "jul/25", valor: 71 },
      { competencia: "ago/25", valor: 70 }, { competencia: "set/25", valor: 71 },
      { competencia: "out/25", valor: 71 }, { competencia: "nov/25", valor: 71 },
      { competencia: "dez/25", valor: 71 }, { competencia: "jan/26", valor: 72 },
