...
export const coberturas = {
  ...
  regionais: [
    { nome: "Regional SP", coberturas: 2840, score: 82, regular: 58, regularH: "4.2K", he: 20, heH: "1.4K", falta: 12, faltaH: "890", atrasos: 10, atrasosH: "720", tendencia: "melhorando" },
    { nome: "Regional RJ", coberturas: 2120, score: 71, regular: 52, regularH: "2.8K", he: 26, heH: "1.4K", falta: 14, faltaH: "750", atrasos: 8, atrasosH: "430", tendencia: "estavel" },
    { nome: "Regional MG", coberturas: 1560, score: 76, regular: 54, regularH: "2.1K", he: 22, heH: "870", falta: 13, faltaH: "510", atrasos: 11, atrasosH: "430", tendencia: "melhorando" },
    { nome: "Regional PR", coberturas: 1180, score: 65, regular: 48, regularH: "1.4K", he: 28, heH: "840", falta: 15, faltaH: "450", atrasos: 9, atrasosH: "270", tendencia: "piorando" },
    { nome: "Regional BA", coberturas: 980, score: 58, regular: 42, regularH: "1.0K", he: 32, heH: "800", falta: 16, faltaH: "400", atrasos: 10, atrasosH: "250", tendencia: "piorando" },
  ] as any[],
...
export const compliance = {
  ...
  insights: [
    { icone: "⚠️", texto: "418 violações de interjornada representam o maior risco jurídico da operação, concentrando 49% do total de ocorrências no período.", tipo: "atencao" as const },
...
export const vacationData = {
  ...
  insights: [
    { tone: "negative" as const, text: "Cobertura por HE chegou a 41% em jul/25 e 39% em jan/26 — meses de pico de volume. Evidência de que a reserva técnica está subdimensionada para a sazonalidade da operação." },
    { tone: "warning" as const, text: "Férias lançadas na correria (<3m) subiram de 18% para 42% no último trimestre. Disciplina de programação piorou e pressiona a reserva técnica nos próximos meses." },
    { tone: "positive" as const, text: "Ponto batido em férias caiu de 1,8% (set/25) para 0,6% (mar/26) — redução consistente do passivo trabalhista. Concentração remanescente está na Capital BA." },
  ],
  kpisTopo: {
    coberturasHE12m: { valor: 28, variacao: -4, unidade: "pp", classification: "Atenção", tooltip: "Percentual das coberturas de férias dos últimos 12 meses que foram realizadas com hora extra. Valores altos indicam reserva técnica subdimensionada e custo operacional evitável." },
    antecedenciaMedia: { valor: 4.2, variacao: 0.6, unidade: "meses", classification: "Atenção", tooltip: "Tempo médio entre o lançamento das férias no sistema e o início efetivo do período. Janela ideal: 6 a 12 meses. Abaixo de 3 meses indica gestão reativa e risco operacional." },
  },
  retrospectiva: {
    volumeMensal: [
      { mes: "abr/25", pct: 14, abs: 168 },
      { mes: "mai/25", pct: 16, abs: 192 },
      { mes: "jun/25", pct: 19, abs: 228 },
      { mes: "jul/25", pct: 28, abs: 336 },
      { mes: "ago/25", pct: 21, abs: 252 },
      { mes: "set/25", pct: 13, abs: 156 },
      { mes: "out/25", pct: 11, abs: 132 },
      { mes: "nov/25", pct: 12, abs: 144 },
      { mes: "dez/25", pct: 26, abs: 312 },
      { mes: "jan/26", pct: 27, abs: 324 },
      { mes: "fev/26", pct: 16, abs: 192 },
      { mes: "mar/26", pct: 13, abs: 156 },
    ],
    composicaoCobertura: [
      { mes: "abr/25", ferista: 48, remanejo: 22, he: 24, naoCoberta: 6, pctHE: 24, total: 168 },
      { mes: "mai/25", ferista: 45, remanejo: 24, he: 26, naoCoberta: 5, pctHE: 26, total: 192 },
      { mes: "jun/25", ferista: 42, remanejo: 23, he: 30, naoCoberta: 5, pctHE: 30, total: 228 },
      { mes: "jul/25", ferista: 32, remanejo: 21, he: 41, naoCoberta: 6, pctHE: 41, total: 336 },
      { mes: "ago/25", ferista: 40, remanejo: 22, he: 33, naoCoberta: 5, pctHE: 33, total: 252 },
      { mes: "set/25", ferista: 52, remanejo: 24, he: 20, naoCoberta: 4, pctHE: 20, total: 156 },
      { mes: "out/25", ferista: 55, remanejo: 25, he: 17, naoCoberta: 3, pctHE: 17, total: 132 },
      { mes: "nov/25", ferista: 54, remanejo: 24, he: 19, naoCoberta: 3, pctHE: 19, total: 144 },
      { mes: "dez/25", ferista: 35, remanejo: 22, he: 38, naoCoberta: 5, pctHE: 38, total: 312 },
      { mes: "jan/26", ferista: 34, remanejo: 22, he: 39, naoCoberta: 5, pctHE: 39, total: 324 },
      { mes: "fev/26", ferista: 50, remanejo: 24, he: 23, naoCoberta: 3, pctHE: 23, total: 192 },
      { mes: "mar/26", ferista: 58, remanejo: 25, he: 15, naoCoberta: 2, pctHE: 15, total: 156 },
    ],
    antecedencia: [
      { mes: "abr/25", adiantada: 12, ideal: 38, apertada: 32, naCorreria: 18, total: 168 },
      { mes: "mai/25", adiantada: 14, ideal: 40, apertada: 31, naCorreria: 15, total: 192 },
      { mes: "jun/25", adiantada: 10, ideal: 35, apertada: 34, naCorreria: 21, total: 228 },
      { mes: "jul/25", adiantada: 8, ideal: 32, apertada: 35, naCorreria: 25, total: 336 },
      { mes: "ago/25", adiantada: 9, ideal: 34, apertada: 33, naCorreria: 24, total: 252 },
      { mes: "set/25", adiantada: 11, ideal: 36, apertada: 30, naCorreria: 23, total: 156 },
      { mes: "out/25", adiantada: 13, ideal: 38, apertada: 28, naCorreria: 21, total: 132 },
      { mes: "nov/25", adiantada: 12, ideal: 39, apertada: 28, naCorreria: 21, total: 144 },
      { mes: "dez/25", adiantada: 9, ideal: 30, apertada: 30, naCorreria: 31, total: 312 },
      { mes: "jan/26", adiantada: 7, ideal: 28, apertada: 32, naCorreria: 33, total: 324 },
      { mes: "fev/26", adiantada: 8, ideal: 26, apertada: 28, naCorreria: 38, total: 192 },
      { mes: "mar/26", adiantada: 8, ideal: 22, apertada: 28, naCorreria: 42, total: 156 },
    ],
    pontoBatidoFerias: [
      { mes: "abr/25", pct: 0.8, ocorrencias: 18, opLider: "Capital BA" },
      { mes: "mai/25", pct: 1.1, ocorrencias: 26, opLider: "Capital BA" },
      { mes: "jun/25", pct: 1.3, ocorrencias: 34, opLider: "Capital BA" },
      { mes: "jul/25", pct: 1.6, ocorrencias: 45, opLider: "Capital BA" },
      { mes: "ago/25", pct: 1.4, ocorrencias: 36, opLider: "Interior BA" },
      { mes: "set/25", pct: 1.8, ocorrencias: 47, opLider: "Capital BA" },
      { mes: "out/25", pct: 1.2, ocorrencias: 28, opLider: "Grande RJ" },
      { mes: "nov/25", pct: 1.0, ocorrencias: 22, opLider: "Grande RJ" },
      { mes: "dez/25", pct: 1.5, ocorrencias: 42, opLider: "Capital BA" },
      { mes: "jan/26", pct: 1.3, ocorrencias: 38, opLider: "Capital BA" },
      { mes: "fev/26", pct: 0.9, ocorrencias: 20, opLider: "Interior MG" },
      { mes: "mar/26", pct: 0.6, ocorrencias: 13, opLider: "Interior MG" },
    ],
  },
};
