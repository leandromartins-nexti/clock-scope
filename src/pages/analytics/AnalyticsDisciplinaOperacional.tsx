  ...
  const content = (
    <div className="flex flex-1 min-h-0">
      <div className="flex-1 min-w-0 overflow-y-auto">
        ...
        {activeSubTab === "absenteismo" && <AbsenteismoV2Content selectedRegional={selectedRegional} onRegionalClick={handleRegionalClick} groupBy={groupBy} onGroupByChange={handleGroupByChange} />}
      ...
      <div className="flex-1 min-w-0 space-y-3 px-3 sm:pl-6 sm:pr-4 py-4 pb-24 xl:pb-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3">
          ...
          <div className={`bg-card border rounded-xl p-4 ${selectedMes ? "border-[#FF5722]/30" : "border-border/50"}`}>
            ...
            <ResponsiveContainer width="100%" height={280}>
              <ComposedChart data={qualidadeComHeadcount} margin={{ top: 50, right: 5, bottom: 50, left: 5 }} onClick={(e: any) => {
