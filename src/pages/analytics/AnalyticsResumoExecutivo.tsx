              ...
              {sparklineCards.map((card) => {
                ...
                <div
                  ...
                  >
                    ...
                    <div className="flex sm:hidden flex-1 min-w-0 h-[32px] flex-col justify-between overflow-hidden self-center">
                      <div className="flex items-center gap-[2px] w-full h-[24px]">
